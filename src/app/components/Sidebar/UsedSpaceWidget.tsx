export function UsedSpaceWidget() {
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      ...
      <div className="dark h-2 rounded-full bg-violet-100 dark:bg-zinc-600">
      ...
      <div className="space-x-3">
        ...
        <button
          type="button"
          className="text-sm font-medium text-violet-700 hover:text-violet-900 dark:text-zinc-300 dark:hover:text-violet-300"
        >
          Upgrade Plan
        </button>
      </div>
